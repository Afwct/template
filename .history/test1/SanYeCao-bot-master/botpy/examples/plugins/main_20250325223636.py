import jmcomic.jm_entity
import jmcomic, os, time, yaml, githubUpload
...
def callback(album, photo):
    global file_name
    file_name = album.name
...
def autoDown(args):
    ...
    # manhua = [f"{args}"]
    try:
        jmcomic.download_album(args, loadConfig, None, callback)
        ...
        print(f"Error: {e}. Continuing execution...")
    except Exception as e:
        print(f"An unexpected error occurred: {e}. Continuing execution...")
        return file_name
