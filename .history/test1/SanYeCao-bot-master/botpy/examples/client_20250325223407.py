...
from plugins import weather_api, img_upload, fortune_by_sqlite, user_todo_list, main, githubUpload
...
class MyClient(botpy.Client):
    ...
    async def on_group_at_message_create(self, message: GroupMessage):
        ...
        if msg == f"我喜欢你":
            ...
            if a is not None:
                flag = await githubUpload.upload("D:/pythonProject/JMComic/18comic_dow/books/{a}.pdf")
            if flag:
                file_url = await githubUpload.getImage(f"{a}.pdf")
