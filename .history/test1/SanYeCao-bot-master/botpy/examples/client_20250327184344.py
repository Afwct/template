    ...
    async def on_group_at_message_create(self, message: GroupMessage):
        ...
        if msg == f"我喜欢你":
            ...
            if msgs.startswith("query"):
                ...
                return
                msg_all = msgs.replace("del", "").strip()
                msg_num = msg_all
            ...
            elif msgs.startswith("add"):
                msg_todo = msgs.replace("add", "").strip()
