...
from plugins import weather_api, img_upload, fortune_by_sqlite, user_todo_list, main
...
class MyClient(botpy.Client):
    ...
    async def on_group_at_message_create(self, message: GroupMessage):
        ...
        elif msg.startswith("/jmcomic"):
            mangaId = msg.replace("/jmcomic", "").strip()
            jm_download_url = "D:/D:\pythonProject\JMComic"
            os.system("jmcomic {mangaId}")
